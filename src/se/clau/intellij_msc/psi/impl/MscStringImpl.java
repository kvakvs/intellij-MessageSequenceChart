...
public class MscStringImpl extends ASTWrapperPsiElement implements MscString {

  public MscStringImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getStringLit() {
    return findNotNullChildByType(STRING_LIT);
  }
